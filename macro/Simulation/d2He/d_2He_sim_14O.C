...
void d_2He_sim_14O(Int_t nEvents = 100, TString mcEngine = "TGeant4", TString geovar = "_07atm" )
{
 ...
 const TString pathtodata = "/projects/ceclub/giraud/ATTPCROOTv2/macro/Simulation/d2He/";
  // Output file name
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
		  ...
		  Double_t kBeam = 100.0;
  	          Double_t BExcEner = 0.0;
                  ...
                  Double_t NomEnergy = 0.0858025; //was 1//Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
